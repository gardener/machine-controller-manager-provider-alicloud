...
test-integration:
	...
	if [[ -f $(PWD)/$(MACHINECLASS_V1) ]]; then export MACHINECLASS_V1=$(MACHINECLASS_V1);elif [[ -f $(PWD)/$(MACHINECLASS_V1) ]]; then export MACHINECLASS_V1="$(MACHINECLASS_V1)"; fi; \
	if [[ -f $(PWD)/$(MACHINECLASS_V2) ]]; then export MACHINECLASS_V2=$(MACHINECLASS_V2);elif [[ -f $(PWD)/$(MACHINECLASS_V2) ]]; then export MACHINECLASS_V2="$(MACHINECLASS_V2)"; fi; \
